    ...
    <section className="about">
      ...
      <div className="about__video">
        <div className="about__video__play">
          {/* TODO: add onClick for img and span */}
          <img src={playImg} alt="play" className="about__video__play__img"/>
          <span className="about__video__play__text">WATCH OUR STORY</span>
        </div>
      </div>
    </section>
  );
